...
def main():
	"""
	TODO: draw a sierpinski triange at the designated order
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	"""
	:param order: order of triangles to be executed
	:param length: length of the biggest triangle
	:param upper_left_x: the most upper left corner x-coordinate of the shape
	:param upper_left_y: the most upper left corner y-coordinate of the shape
	:return: an image with the sierpinski triangle with the assigned order
	"""
	if order == 0:
		pass
	else:
